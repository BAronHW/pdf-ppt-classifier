...
def classify_pdf(file_path: str, model: SVC, scaler: StandardScaler, label_encoder: LabelEncoder) -> str:
    try:
...
if __name__ == "__main__":
    ...
    test_pdf_path = r'C:\Users\Aaron\OneDrive - Lancaster University\Documents\my projects\pdf-ppt-classifier\THE OTHERS.pdf'
